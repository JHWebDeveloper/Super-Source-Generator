...
interop.dialog = Object.freeze({
	sourceOnTopAlert: async () => (await ipcRenderer.invoke('showMessageBox', {
		type: 'warning',
		buttons: ['OK', 'Cancel'],
	...
	directoryNotFoundAlert: async dir => (await ipcRenderer.invoke('showMessageBox', {
		type: 'warning',
	...
	deleteDirectoryAlert: async label => (await ipcRenderer.invoke('showMessageBox', {
		type: 'warning',
		buttons: ['OK', 'Cancel'],
